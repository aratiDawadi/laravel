...
Route::get('/document', 'App\Http\Controllers\HomeController@pokhara');
...
Route::get('/managebooks', 'App\Http\Controllers\HomeController@getmanagebooks')->name('getmanagebooks')->middleware('auth');
Route::post('/add/book', 'App\Http\Controllers\HomeController@postAddBook')->name('postAddBook');
